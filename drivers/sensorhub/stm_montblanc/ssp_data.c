...
static void get_uncalib_geomagnetic_sensordata(char *pchRcvDataFrame, int *iDataIdx,
	struct sensor_value *sensorsdata)
{
...
void initialize_function_pointer(struct ssp_data *data)
{
	...
	data->get_sensor_data[GEOMAGNETIC_UNCALIB_SENSOR] = get_uncalib_geomagnetic_sensordata;
